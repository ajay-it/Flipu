...
import com.example.flipu.databinding.ActivityCheckoutBinding
...
class CheckoutActivity : AppCompatActivity(), PaymentResultListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkout.setKeyID("rzp_test_9xXw1OcMPuJ6S8")

        val price = intent.getStringExtra("totalCost")

        try {
            val options = JSONObject()
            options.put("name","Flipu")
            ...
            prefill.put("email","2k00ajay@gmail.com")
            prefill.put("contact","9752844612")
