...
import com.example.flipu.databinding.ActivityAddressBinding
...
class AddressActivity : AppCompatActivity() {
    ...
    private fun validateData(
        ...
        if(name.isEmpty() || number.isEmpty() || village.isEmpty() ||
            ...
            storeDate(village, city, state, pinCode)
    }

    private fun storeDate(village: String, city: String, state: String, pinCode: String) {
